...
# https://huggingface.co/levihsu/OOTDiffusion/resolve/main/checkpoints/ootd/vae/config.json
class OOTDiffusionDC:
    ...
    def __init__(self, gpu_id):
        ...
        unet_garm = UNetGarm2DConditionModel.from_pretrained(
            ...
            # subfolder="checkpoints/ootd/ootd_dc/checkpoint-36000/unet_garm",
            torch_dtype=torch.float16,
        ...
        unet_vton = UNetVton2DConditionModel.from_pretrained(
            UNET_PATH,
            # MODEL_PATH,  # UNET_PATH,
            # subfolder="checkpoints/ootd/ootd_dc/checkpoint-36000/unet_vton",
            torch_dtype=torch.float16,
            use_safetensors=True,
        )
        ...
        self.pipe = OotdPipeline.from_pretrained(
            MODEL_PATH,
            # subfolder="checkpoints/ootd",
            # cache_dir="/root/.cache/huggingface/hub/models--levihsu--OOTDiffusion/snapshots/5700fb798e70ed5571e68270ec9e709b6e72a532",
            unet_garm=unet_garm,
            unet_vton=unet_vton,
            vae=vae,
            torch_dtype=torch.float16,
